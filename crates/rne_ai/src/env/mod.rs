...
pub use mobile_manipulator::{
    ...
    MobileManipulatorEpisodeConfig, MobileManipulatorSim, VectorizedMobileManipulatorConfig,
    VectorizedMobileManipulatorEnv, VectorizedMobileManipulatorStep, MM_MOBILE_TRACK_WIDTH_M,
