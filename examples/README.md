...
| PLATEAU city-drive GIFs | `cargo run -p plateau_drone_gif --example 46_plateau_drone_gif` | Converts a CC0 ten-building PLATEAU-style avenue, runs deterministic Ackermann traffic, and renders daylight aerial and stable car-follow animations |
