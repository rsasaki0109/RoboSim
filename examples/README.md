...
| Go2 contact-schedule search | `cargo run --release -p go2_stepped_turn --example 55_go2_stepped_turn` | Searches per-leg phase/duty/placement schedules for a faster turn and verifies the pinned negative result: contact re-sequencing does not beat the overlay |
