...
| PLATEAU traffic + LiDAR GIF | `cargo run --release -p plateau_drone_gif --example 46_plateau_drone_gif` | Imports the official Sanjo PLATEAU tile, runs 100 vehicles, captures seeded material/weather-aware LiDAR, and renders the 12-second README GIF |
