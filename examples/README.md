...
| G1 learned stride hero GIF | `cargo run --release -p g1_stride_gif --example 63_g1_stride_gif` | Renders the stepper and the speed-up learned stride side by side with measured-window trails; use `-- --smoke` for the GPU-free CI path |
