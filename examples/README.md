...
| G1 learned stride | `cargo run --release -p g1_learned_stride --example 62_g1_learned_stride` | Verifies the humanoid's first real steps and speed-up pass: a learned torque overlay reaches about 0.027 m/s at full height and dead straight; `-- --train` reproduces the search |
