...
| PLATEAU city-drive GIF | `cargo run --release -p plateau_drone_gif --example 46_plateau_drone_gif` | Imports the official Sanjo PLATEAU tile, runs the shared traffic route follower, and renders the 12-second README GIF |
