//! Exports a diff-drive episode in the house 3DGS interior as EuRoC stereo+IMU.
//!
...
//!
//! Usage: `112_house_3dgs_euroc_export OUTPUT_DIR`
...
const CAMERA_HEIGHT_OFFSET_M: f64 = 0.80;
...
fn main() -> Result<(), Box<dyn Error>> {
    let output = std::env::args_os()
        .nth(1)
        .map(PathBuf::from)
        .ok_or_else(|| io::Error::other("usage: 112_house_3dgs_euroc_export OUTPUT_DIR"))?;
    for dir in [
