...
<p align="center">
  ...
  <br>
  <sub>The blue panel is the plain hybrid stepper; the orange panel uses the pinned learned torque overlay at <code>stride_rad = 0.07</code>, <code>foot_lift_rad = 0.10</code>, and <code>cycle_steps = 100</code>. Both panels discard the same 8&nbsp;s transient before the learned walker clears about 0.20&nbsp;m in each measured window while staying at full height. The real wgpu capture is generated by example 63; the headless smoke path is part of CI.</sub>
</p>
