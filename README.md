<p align="center">
  <picture>
    ...
    <img src="docs/media/rne-hero.gif" alt="RNE mobile manipulator navigating a house scene, grasping a block, and placing it on a shelf" width="960">
  </picture>
  <br>
  <sub>Generated by <code>examples/27_mobile_manipulator_rl/house_gif_demo.py</code> as a reproducible navigate-pick-place GIF artifact (<a href="docs/media/rne-hero.json">metadata</a>)</sub>
</p>
