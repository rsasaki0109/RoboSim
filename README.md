...
<p align="center">
  <picture>
    ...
    <img src="docs/media/unitree-g1-learned-stride.gif" alt="Side-by-side official Unitree G1 stepper and command-conditioned differential-steering stride, with measured-window trails" width="960">
  </picture>
  <br>
  <sub>The blue panel is the plain hybrid stepper at the v0.1 forward command (<code>0.0276&nbsp;m/s</code>); the orange panel uses the pinned learned torque overlay with the same speed command plus <code>+0.05&nbsp;rad/s</code> differential steering. Both panels discard the same 8&nbsp;s transient before the commanded walker clears <code>0.196&nbsp;m</code> and <code>0.235&nbsp;m</code> in its measured windows while staying at full height. The real wgpu capture is generated by example 63; the headless smoke path is part of CI.</sub>
</p>
