...
<p align="center">
  <picture>
    ...
    <img src="docs/media/unitree-g1-learned-stride.gif" alt="Side-by-side official Unitree G1 stepper and learned torque stride, with the learned walker leaving a measured-window trail" width="960">
  </picture>
  <br>
  <sub>The blue panel is the plain hybrid stepper; the orange panel uses the pinned learned torque overlay at <code>stride_rad = 0.065</code>, <code>foot_lift_rad = 0.12</code>, and <code>cycle_steps = 100</code>. Both panels discard the same 8&nbsp;s transient before the learned walker clears about 0.22&nbsp;m in each measured window while staying at full height. The real wgpu capture is generated by example 63; the headless smoke path is part of CI.</sub>
</p>
