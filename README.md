...
| Vehicle dynamics | Dynamic bicycle model, tire saturation, explicit differential-drive caster and four-wheel Ackermann suspension dynamics, cross-backend contact/load evidence, sensor latency, and deterministic evaluation | [Vehicle dynamics](docs/VEHICLE_DYNAMICS.md), [caster benchmark](docs/MOBILITY_DIFFERENTIAL_CASTER_V1.md), [Ackermann benchmark](docs/MOBILITY_ACKERMANN_SUSPENSION_V1.md), examples 49–51 |
