...
- [OpenArm Rapier / native MuJoCo / Gazebo proof](docs/OPENARM_CROSS_SIM_PROOF.md), including typed-sensor dropout, stale-age, recovery, and repeated-burst re-arm boundaries
