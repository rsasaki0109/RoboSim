...
pub const INSTALLED_FLAGSHIP_PROOF_REPORT_SCHEMA_VERSION: u32 = 4;
/// Stable artifact kind for an extracted release-bundle verification report.
pub const INSTALLED_BUNDLE_VERIFICATION_REPORT_KIND: &str =
    "rne_installed_bundle_verification_report";
/// Current schema version for an extracted release-bundle verification report.
pub const INSTALLED_BUNDLE_VERIFICATION_REPORT_SCHEMA_VERSION: u32 = 1;
...
pub const TIME_TO_PROOF_REPORT_SCHEMA_VERSION: u32 = 2;

pub mod failure_capsule;
pub mod installed_bundle;
