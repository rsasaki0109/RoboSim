...
| `historical_compatibility` | A retained report exactly equal to a fresh execution of at least 30 registered typed-reader checks, including fail-closed accelerator capability/status, future/unknown-field mutations, and verified historical Git revision/tree/blob provenance |
...
including external identities and support fields. The retained 30-check
