...
| `historical_compatibility` | A retained report exactly equal to a fresh execution of at least 31 registered typed-reader checks, including fail-closed accelerator capability/status/conformance, future/unknown-field mutations, and verified historical Git revision/tree/blob provenance |
...
including external identities and support fields. The retained 31-check
