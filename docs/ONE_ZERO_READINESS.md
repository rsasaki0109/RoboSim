...
| `historical_compatibility` | A retained report exactly equal to a fresh execution of at least 25 registered typed-reader checks, including fail-closed future/unknown-field mutations and verified historical Git revision/tree/blob provenance |
...
including external identities and support fields. The retained 25-check
