...
| `historical_compatibility` | A retained report exactly equal to a fresh execution of at least 29 registered typed-reader checks, including fail-closed future/unknown-field mutations and verified historical Git revision/tree/blob provenance |
...
including external identities and support fields. The retained 29-check
