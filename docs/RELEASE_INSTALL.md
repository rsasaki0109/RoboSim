...
- `rne-0.4.0-x86_64-unknown-linux-gnu.tar.gz`
- `rne-0.4.0-x86_64-pc-windows-msvc.zip`
...
```bash
cd rne-0.4.0-x86_64-unknown-linux-gnu
...
`v0.4.0` tag points to the tested commit.
