...
The UDP adapter for ports 10300-10302 lives in `adapters/ssl` ([SSL_ADAPTER.md](SSL_ADAPTER.md)); example 87 couples decoded commands into the small-pitch plant.
...
| G | Humanoid heading-yaw v0.2 / v0.2.1 | Bounded true-heading target/error metrics, stance/swing-aware hybrid control, deterministic bilateral CEM candidate search, example 68, and updated G1 docs/CI | Done (v0.2: 240-tick final-yaw sign; v0.2.1: 480-tick mean yaw-rate sign; sustained integrated-yaw hold remains future work) |
