...
and pass the registered tolerances with explicit units. The Failure Capsule binds the task,
model, configuration, reports, replay, browser inspector, producer, and
installed-bundle verification by size and SHA-256.
