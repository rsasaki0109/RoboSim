...
// Squash of the original `be53f16` freeze onto `main` (#180). The pre-squash
// tip is retained as an object but is no longer an ancestor of HEAD.
const HISTORICAL_FRONTEND_V1_REVISION: &str = "9e1ea8cb2dab8f468cf7bc51fac8bd381359acc4";
const HISTORICAL_FRONTEND_V1_TREE: &str = "5d888b77e0d4785fa57c9edd10ce1292089fab5a";
