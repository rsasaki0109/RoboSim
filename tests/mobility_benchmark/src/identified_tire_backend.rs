...
/// Current schema for identified tire application evidence.
pub const IDENTIFIED_TIRE_BACKEND_SCHEMA_VERSION: u32 = 1;
/// Maximum accepted serialized profile size.
pub const MAX_IDENTIFIED_TIRE_PROFILE_BYTES: usize = 64 * 1024 * 1024;

/// Self-contained steady-plus-transient tire profile with both axes bound.
...
pub struct IdentifiedTireProfileEvidence {
    ...
    /// Exact steady parameters plus separately fitted longitudinal/lateral lengths.
