...
pub(crate) use rne_accelerator_contract::{
    ...
    ACCELERATOR_MANIFEST_SCHEMA_VERSION, ACCELERATOR_PROCESS_CONFORMANCE_REPORT_SCHEMA_VERSION,
    ACCELERATOR_PROTOCOL_SCHEMA_VERSION, ACCELERATOR_RUNTIME_CONTRACT_SCHEMA_VERSION,
